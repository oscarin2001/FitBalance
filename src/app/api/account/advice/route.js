...
${wantTypesText}`;
    ...
    // NOTE: Fallback generation of basic items removed — IA is expected to supply meal items.

    // NOTE: Initial fallback removed — do not synthesize meals on server side.
